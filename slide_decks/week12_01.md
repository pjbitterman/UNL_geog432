...
- download *unit12inclass.zip* from Canvas
...
- Visualize it
- Create a weights matrix based on a *reaonable* conceptualization of a neighborhood. How do you know what's *reaonable*?

...
- What did you do?
    ...
    1. Interpolate a precipitation surface from your points
    2. Reclassify the interpolated surface into an ordinal classification of precipitation "zones" that delineate relatively dry, medium, and wet regions
    3. Create vector polygons from the zones
    4. Clip the zone polygons to the boundary of Nebraska
